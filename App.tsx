...
import { motion, AnimatePresence, useMotionValue, useTransform, animate, useInView, useSpring, useScroll } from 'framer-motion';
...
const Header: React.FC = () => {
  ...
  return (
    <motion.header 
      ...
      className={`fixed top-0 w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-atlas-bg/90 backdrop-blur-md border-b border-atlas-support' : 'bg-transparent'}`}
    >
      <nav className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        <motion.div 
          ...
          whileHover={{ x: 5 }}
        >
          <div className="w-8 h-8 bg-atlas-primary rounded flex items-center justify-center transform group-hover:rotate-12 transition-transform">
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="flex flex-col gap-6 text-lg font-medium">
              <a href="#solucoes" onClick={() => setIsMobileMenuOpen(false)}>Soluções</a>
              ...
              <a href="#contato" onClick={() => setIsMobileMenuOpen(false)} className="text-atlas-primary">Falar com Consultor</a>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
    ...
    >
      <AnimatePresence mode="wait">
        {step < questions.length ? (
          ...
          >
            <span className="text-xs font-bold text-atlas-primary uppercase tracking-widest mb-4 block">Pergunta {step + 1} de {questions.length}</span>
            ...
            <div className="grid gap-4">
              {questions[step].options.map((opt, i) => (
                <motion.button 
                  ...
                  whileHover={{ scale: 1.02, borderColor: '#00A6C8', backgroundColor: 'rgba(11, 60, 74, 0.2)' }}
                  whileTap={{ scale: 0.98 }}
          ...
          >
            ...
            <p className="text-atlas-secondary mb-8">Baseado em suas respostas, este pacote possui as ferramentas ideais para seu estágio atual.</p>
            <motion.a 
              href="#solucoes" 
...
const FAQItemComponent: React.FC<{ item: typeof FAQ_ITEMS[0] }> = ({ item }) => {
  ...
  return (
    <motion.div layout className="border-b border-atlas-support last:border-0">
      ...
      >
        <span className="text-lg font-medium text-atlas-secondary group-hover:text-white transition-colors">{item.question}</span>
        <motion.span
        ...
        <section className="relative pt-44 pb-32 px-6 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto text-center relative z-10">
            ...
            >
              ...
              Entregamos sua Landing Page + Google Maps em até <span className="text-white font-bold">24 horas</span>.
            </motion.p>
        ...
        >
          <div className="max-w-7xl mx-auto">
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold mb-6">Infraestrutura digital <br/> que gera autoridade.</h2>
                <p className="text-atlas-secondary text-lg mb-8">
                  Diferente de landing pages genéricas, nossas entregas são pensadas como produtos. Código limpo, SEO técnico impecável e foco absoluto em conversão de alto valor.
                </p>
              ...
              <motion.div 
                ...
                className="bg-atlas-bg rounded-2xl border border-atlas-support p-8 relative overflow-hidden"
              >
            ...
            >
              {PACKAGES.map((pkg) => (
                <motion.div 
                  ...
                  className={`relative p-8 rounded-2xl border transition-all duration-300 flex flex-col ${pkg.highlight ? 'bg-atlas-surface border-atlas-primary/50' : 'bg-atlas-surface/50 border-atlas-support'}`}
                >
                  ...
                  <div className="pt-6 border-t border-atlas-support/50">
                    ...
                    <motion.a 
                      ...
                      className={`w-full py-4 rounded-xl font-bold transition-all block text-center ${pkg.highlight ? 'bg-atlas-primary text-white hover:brightness-110' : 'bg-atlas-bg border border-atlas-support text-white hover:border-atlas-primary'}`}
                    >
                      Selecionar Solução
                    </motion.a>
                  </div>
        ...
        <section id="como-funciona" className="py-32 px-6">
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-atlas-secondary text-lg max-w-2xl mx-auto">
                Nosso processo é técnico e transparente. Do diagnóstico à sustentação contínua.
              </p>
            </motion.div>
            ...
            >
              {[
                ...
                >
                  <div className="text-6xl font-black text-atlas-support/50 mb-4 group-hover:text-atlas-primary/40 transition-colors">{item.step}</div>
        ...
        <section id="cases" className="py-32 px-6 bg-atlas-surface/30">
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <motion.button 
                whileHover={{ x: 5 }}
                className="flex items-center gap-2 text-atlas-primary font-bold hover:underline"
              >
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-20 items-center">
              <motion.div
                ...
                variants={fadeUp}
              >
                <h2 className="text-4xl md:text-5xl font-bold mb-8">Vamos construir sua <br/> próxima vantagem <span className="text-atlas-primary">competitiva</span>?</h2>
      ...
      <footer className="py-16 px-6 border-t border-atlas-support/30 bg-atlas-bg relative z-10">
        <div className="max-w-7xl mx-auto">
            ...
            <div className="col-span-1 md:col-span-2 space-y-6">
              ...
              >
                <div className="w-8 h-8 bg-white rounded flex items-center justify-center">
                  <span className="text-atlas-bg font-bold text-sm">A</span>
                </div>
                <span className="text-xl font-bold tracking-tight">ATLAS</span>
              </motion.div>
              <p className="text-atlas-secondary text-sm max-w-sm leading-relaxed">
                Arquitetura de produtos digitais robustos com foco em performance e escala. 
                Líderes em implantação express para soluções corporativas.
              </p>
          ...
          <div className="pt-8 border-t border-atlas-support/20 flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="text-xs text-atlas-support">
              © 2024 Atlas Soluções Digitais. Todos os direitos reservados.
            </div>
            <div className="flex gap-6 text-xs text-atlas-support">
              {['Política de Privacidade', 'Termos de Uso', 'Compliance'].map((item, i) => (
                <motion.span 
                  key={i}
                  whileHover={{ color: '#C7CCD6' }}
                  className="cursor-pointer transition-colors"
                >
                  {item}
                </motion.span>
